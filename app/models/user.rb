...
class User
  ...
  index({:login => 1}, {:background => true, :unique => true})
  index({:remember_token => -1},{:background => true, :unique => true, :sparse => true})
  index({:api_key => -1}, {:background => true, :unique => true, :sparse => true})
