$(document).ready(function() {
    ...
    $.ajax({
        url: getBaseUrl() + '/a/dashboards/writable',
        ...
        dashboardGrid = $(".gridster ul").gridster({
            ...
            draggable: {
                stop: function() {
                    ...
                    $.ajax({
                        url: getBaseUrl() + '/a/dashboards/' + dashboardId + '/positions',
                        type: 'POST',
    ...
    $(".dashboard .widget .remove-widget").live("click", function(e) {
        ...
        $.ajax({
            url: getBaseUrl() + '/a/dashboards/' + widget.attr("data-dashboard-id") + '/widgets/' + widget.attr("data-widget-id") + '/delete',
            type: 'POST',
            success: function() {
    ...
    (function updateDashboardWidgets() {
        ...
        $(".dashboard .widget[data-widget-type]").each(function() {
            ...
            $.ajax({
                url: getBaseUrl() + '/a/dashboards/' + dashboardId + '/widgets/' + widgetId + '/value',
                type: 'GET',
                success: function(data) {
    ...
    $("#dashboardwidget-cache-time button.update-cachetime").on("click", function() {
        ...
        $.ajax({
            url: getBaseUrl() + '/a/dashboards/' + dashboardId + '/widgets/' + widgetId + '/cachetime',
            data: {
                cacheTime: newVal
            },
            type: 'POST',
    ...
    $("button.update-description").on("click", function() {
        ...
        $.ajax({
            url: getBaseUrl() + '/a/dashboards/' + dashboardId + '/widgets/' + widgetId + '/description',
            data: {
                description: newVal
            },
            type: 'POST',
...
function addWidget(dashboardId, description, params) {
    ...
    $.ajax({
        url: getBaseUrl() + '/a/dashboards/' + dashboardId + '/widgets',
        type: 'POST',
        data: params,
        success: function() {
