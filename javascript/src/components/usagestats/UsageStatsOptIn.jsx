            ...
            if (this.state.optOutState !== null && this.state.optOutState.opt_out === true) {
                ...
                form = (
                    <span>
                        <i className="fa fa-info-circle"></i>
                        &nbsp;
                        You have currently <strong>enabled</strong> sending anonymous usage statistics to Graylog. Thank you! User statistics help us make Graylog better. If you've changed your mind, click "Disable".
